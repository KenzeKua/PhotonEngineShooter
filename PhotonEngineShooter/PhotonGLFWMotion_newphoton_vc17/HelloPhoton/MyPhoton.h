...
public:
	...
	void sendMyData(float xpos, float ypos, float xvel, float yvel, float xaccel, float yaccel, float MouseX, float MouseY);
	void SendShootBullet(bool Shoot);
	void SendShootMissile(bool Shoot);
